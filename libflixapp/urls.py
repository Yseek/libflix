...
urlpatterns = [
    ...
    path('top_login_/',views.top_login, name='top_login_'),
    path('top_login_/login_ok',views.login_ok, name='login_ok'),
    path('top_login_/top_join',views.top_join, name='top_join'),
    path('top_login_/join_ok',views.join_ok, name='join_ok'),
